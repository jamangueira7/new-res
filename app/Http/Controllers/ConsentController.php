...
class ConsentController extends Controller
{
    ...
    public function getConsultaStatus(Request $request)
    {
        ...
        if((string) $url == "ACTIVE"){
            ...
            return response()->json([
                'status'=>'inactive',
                'msg'=> 'Beneficiario INATIVO. Para ativa-lo imprima o termo de ativação, scaneie e salve em PDF (até 2 MB). Depois faça o upload e envie com o botão "Enviar Ativação"'
            ]);
        }
    ...
    public function getAtivacao(Request $request)
    {
       ...
       /* if(Input::hasFile('fileup')) {
            ...
            $file_save->move(public_path('pdf'), $new_name);
        ...
        $headers = array(
            "Content-type: multipart/related; type=\"application/xop+xml\"; start=\"<rootpart@soapui.org>\"; start-info=\"text/xml\"; boundary=\"----=_Part_0_2127922.1555591611437\"",
